            ...
            <div className="House_description">
                ...
                <div className="House_description_right">
                    <div className="House_description_right_description">
                        ...
                        <p className="TextP">This site created in React.js aims to present the services and rental rates for accommodation in the establishment "La Maison du Lac", located near Limoges in the department of Haute-Vienne (87), France.</p>
                        <p className="TextP">On the home page, it presents a description of the establishment and the different accommodations, with some images to illustrate the places.</p>
                        <p className="TextP">It also offers the different possible formulas with a description of each of them, as well as the rates and optional services.</p>
                        <p className="TextP">A Contact page with a Google Maps allows you to locate the precise location, find the best route, or even send an email to the owner of the establishment.</p>
                        <p className="TextP">At the bottom of the page, we find the various links to all external web pages, such as Facebook, Booking.com or even AirBnB.com.</p>
                    </div>
